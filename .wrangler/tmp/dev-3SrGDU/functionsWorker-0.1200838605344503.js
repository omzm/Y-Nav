...
// .wrangler/tmp/pages-s8P5PR/functionsWorker-0.1200838605344503.mjs
...
var KV_MAIN_DATA_KEY = "cloudnav:data";
var KV_BACKUP_PREFIX = "cloudnav:backup:";
...
async function handlePost(request, env) {
  try {
    ...
    const existingData = await env.CLOUDNAV_KV.get(KV_MAIN_DATA_KEY, "json");
    if (existingData && body.expectedVersion !== void 0) {
...
async function handleListBackups(env) {
  try {
    ...
    const backups = list.keys.map((key) => ({
      key: key.name,
...
__name2(handleListBackups, "handleListBackups");
...
// .wrangler/tmp/bundle-gkOLOU/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-gkOLOU/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.1200838605344503.js.map
